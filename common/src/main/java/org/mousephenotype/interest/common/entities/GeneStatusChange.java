...
public class GeneStatusChange {
    ...
    public void setConditionalAlleleProductionCentre(String condtionalAlleleProductionCentre) {
    ...
    public String toString() {
        return "GeneStatusChange{" +
                ...
                ", condtionalAlleleProductionCentre='" + conditionalAlleleProductionCentre + '\'' +
